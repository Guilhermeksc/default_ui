...
from paths import TEMPLATE_TEST1_PATH

def create_content_nota_auditoria_test1(title_text):
    """Creates a content layout with input fields and buttons."""
    ...
    btn_create_docx.clicked.connect(lambda: criar_pasta_e_docx(pasta_input.text(), TEMPLATE_TEST1_PATH, setor_input.text(), natalia_input.text()))
